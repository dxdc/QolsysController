...
class QolsysEvent(StrEnum):
    ...
    EVENT_PANEL_PARTITION_UPDATE = "EVENT_PANEL_PARTITION_CHANGE"
    EVENT_PANEL_ZONE_ADD = "EVENT_PANEL_ZONE_ADD"
    EVENT_PANEL_ZONE_UPDATE = "EVENT_PANEL_ZONE_CHANGE"
    ...
    EVENT_AUTDEV_DEVICE_UPDATE = "EVENT_AUTDEV_DEVICE_UPDATE"
